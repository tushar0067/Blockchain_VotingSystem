...
import loading from '../../assets/Photo/Loading.gif';
import image3 from '../../assets/Photo/image3.jpeg';


const NavBar = () => {
  const {currentAccount, error,connectWallet, } = useContext(VotingContext);
  ...
  return(<div className={Style.navBar}>
    ...
    <div className={Style.navBar_box}>
      ...
      <div className={Style.connect}>
        {currentAccount ? (<div><div className={Style.connect_flex}>
          ...
          {openNav && (
            <div className={Style.navigation}>
              ...
              <p>
                <Link href={{pathname:'/allowed-voter'}}>Voter Registration</Link>
              </p>
              <p>
